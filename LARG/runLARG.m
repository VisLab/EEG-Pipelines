...
filteredFolder = 'E:\LARG128Hz';
largFolder = 'O:\LARGDataNew';
shortName = 'RsvpUA';
icaType = 'runica';
runName = 'run_12';
maxSamplingRate = 128;
finishedFileNameEye = 'finishedEye.mat';
...
% baseFolder = [largFolder filesep studies{studyPos, studyRootPos}];
...
for k = 1:numRecordings
    ...
    if exist([channelFolder filesep finishedFileNameEye], 'file')
    ...
    save([channelFolder filesep finishedFileNameEye], 'recordingRun');
    fprintf('\n');
    diary off;
...
stageFileNames = {['channel' filesep finishedFileNameEye]};
